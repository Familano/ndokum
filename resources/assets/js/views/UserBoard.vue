<template>
    <div>
        <div class="container-fluid hero-section d-flex align-content-center justify-content-center flex-wrap ml-auto background-img">
                    ...
                    <div class="row">
                        <div class="col-md-4 product-box" v-for="(order,index) in orders" @key="index">
                            ...
                            <span class="small-text text-muted">Quantity: {{order.quantity}}
                                <span class="float-right">{{order.is_delivered == 1? "Finnished!" : "not Finnished"}}</span>
                            </span>
                            <br><br>
                            <p><strong>Return Date :</strong> <br>{{order.address}}</p>
                        </div>
                    </div>
                </div>
            </div>
