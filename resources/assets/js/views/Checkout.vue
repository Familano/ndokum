                ...
                <div>
                    ...
                    <div v-if="isLoggedIn">
                        <div class="row">
                            ...
                            <label for="" class="col-md-3 col-form-label">Start Date</label>
                            <div class="col-md-9">
                                <input id="" type="text" class="form-control" v-model="start" required>
                            </div>
                            <label for="address" class="col-md-3 col-form-label">Return Date</label>
                            <div class="col-md-9">
